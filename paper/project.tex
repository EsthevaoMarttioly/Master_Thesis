...
eligible if $y_{i,t}(I,e,\theta) < \bar y$ and that the total number of
beneficiaries is $\text{BF}_t$.
...
\[
\theta w e \left( \frac{\theta w e}{\psi}
\right)^\varphi < \bar y
\quad \Leftrightarrow \quad
e < e^* = \frac{\left( \psi^\varphi \bar y \right)^\frac{1}{1+\varphi}}{\theta w}.
\]
