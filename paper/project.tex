...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{consump_by_state.png}
    \caption{Steady-State Average Consumption by State}
    \label{fig:consump_by_state}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{impc.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{irf_composition.png}
