...
\usepackage[backend=bibtex,style=authoryear,doi=false,isbn=false,url=true]{biblatex}
...
is the aggregate formal labor. Such as \textcite{hagedorn2019fiscal}, the Phillips
curve for price inflation is given by
\[
...
\begin{figure}[H]
    ...
    \caption{IRFs: Financing Rules (shock in $T$)}
